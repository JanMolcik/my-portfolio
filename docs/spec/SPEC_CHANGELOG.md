...
- Replaced the misleading `page_home.roles` field with `page_home.tech_stack`, modeled as a freeform Storyblok tags plugin field so homepage technology tags remain editable without fixed select options.
